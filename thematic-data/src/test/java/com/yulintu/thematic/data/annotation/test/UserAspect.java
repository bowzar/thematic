package com.yulintu.thematic.data.annotation.test;
...
public class UserAspect {
    ...
    @Around("@annotation(com.yulintu.thematic.data.annotation.TransactionAspect2)")
    ...
    @Before("@annotation(com.yulintu.thematic.data.annotation.TransactionAspect)")
    public void beforeTransactionAspect() {
        System.out.println("Before TransactionAspect!");
    }

    @After("@annotation(com.yulintu.thematic.data.annotation.TransactionAspect)")
    public void afterTransactionAspect() {
        System.out.println("After TransactionAspect!");
    }

    @Around("@annotation(com.yulintu.thematic.data.annotation.TransactionAspect)")
